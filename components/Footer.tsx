        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a 
                href="https://www.instagram.com/nextexpotr/" 
                target="_blank" 
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><a href="#" className="hover:text-yellow-400 transition">Özel Dekorasyon</a></li>
              <li><a href="#" className="hover:text-yellow-400 transition">Proje Yönetimi</a></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li>📱 +90 533 483 68 29</li>
              <li>📍 Ali Duran Sk. No:4 Bahçelievler / İstanbul</li>
            </ul>
          </div>
        </div>
